...
public class ShortParking_AutomatedTest {
	...
	public void test02() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 7.00",price.get(1).getText());
	...
	public void test09() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 2,965.00",price.get(1).getText());
	...
	public void test10() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 8,784.00",price.get(1).getText());
	...
	public void test11() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 8,790.00",price.get(1).getText());
