...
public class LongGarageParking_AutomatedTest {
	...
	public void test09() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 1,286.00",price.get(1).getText());
	...
	public void test10() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 3,768.00",price.get(1).getText());
	...
	public void test11() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 3,774.00",price.get(1).getText());
