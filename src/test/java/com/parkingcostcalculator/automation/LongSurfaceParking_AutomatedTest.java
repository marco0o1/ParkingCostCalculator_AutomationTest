...
public class LongSurfaceParking_AutomatedTest {
	...
	public void test09() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 1,072.00",price.get(1).getText());
	...
	public void test10() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 3,140.00",price.get(1).getText());
	...
	public void test11() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 3,146.00",price.get(1).getText());
