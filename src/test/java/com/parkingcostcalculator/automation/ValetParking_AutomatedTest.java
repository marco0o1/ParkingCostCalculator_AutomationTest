...
public class ValetParking_AutomatedTest {
	...
	public void test09() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 2,232.00",price.get(1).getText());
	...
	public void test10() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 6,588.00",price.get(1).getText());
	...
	public void test11() {
		...
		List<WebElement> price =  driver.findElements(By.className("SubHead"));
		assertEquals("$ 6,606.00",price.get(1).getText());
